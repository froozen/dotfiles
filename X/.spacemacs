...
`dotspacemacs/user-config' first."
  ...
  (custom-set-variables
   '(coq-prog-name (concat (getenv "HOME") "/.opam/fol-completeness/bin/coqtop")))
...
you should place your code here."
  ...
  ;; Custom AUCTeX shorthands

  (setq LaTeX-math-list
        '(("vd" "vdash" "Misc Symbol")
          (":" "coloneq")
          ("v+" "bigcup")
          ("v-" "bigcap")
          ))
